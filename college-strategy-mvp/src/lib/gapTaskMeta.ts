...
const RULES: Rule[] = [
  {
    ...
    zh: {
      title: "标化成绩",
      why: "标化策略与分数决定招生官如何把你放进「成绩区间」与奖学金/奖助评估的参考带里。",
      impact: "缺失时，冲/稳/保更容易「拍脑袋」：同一 GPA 下，是否提交分数、分数高低会显著改变名单与风险提示的可靠度。",
    },
    en: {
      title: "Test scores",
  ...
  },
  {
    ...
    zh: {
      title: "GPA 与课程体系",
      why: "不同课程体系（美高 / IB / A-Level / 国内体系）下，GPA 口径不同；顾问需要用它对齐「录取画像」与学校区间。",
      impact: "不补充时，档位边界会变模糊：同一活动叙事下，学校「匹配度」可能被高估或低估。",
    },
    en: {
  ...
  },
  {
    ...
    zh: {
      title: "专业意向",
      why: "专业决定院系资源、先修课、作品集/补充材料与不同学校的「强弱项」对照方式。",
      impact: "不补充时，名单更偏「综合大学泛匹配」，对理工/艺术/商科等特色路径的针对性会下降。",
    },
    en: {
      title: "Major intent",
  ...
  },
  {
    ...
    zh: {
      title: "活动与奖项",
      why: "活动叙事用来解释「为什么这所学校在某一档」：把抽象偏好变成可核对的个人证据链。",
      impact: "不补充时，理由更像模板句，难以判断你是否需要补强「故事线」或调整冲校激进程度。",
    },
    en: {
  ...
  },
  {
    ...
    zh: {
      title: "预算与经济约束",
      why: "国际生奖助政策差异极大；预算决定哪些学校从「匹配」变成「风险项」或反之。",
      impact: "不补充时，财务相关风险会被弱化，可能低估「读得起/奖助难」带来的选校约束。",
    },
    en: {
  ...
  },
  {
    ...
    zh: {
      ...
      impact: "不补充时，对公立/私立与国际生政策的提醒可能不够「落到你身上」。",
    },
    en: {
  ...
  },
  {
    ...
    zh: {
      title: "材料与叙事准备度",
      why: "材料进度决定你能否在关键轮次「把故事讲完整」，也会影响是否该把某些冲校后移。",
  ...
  },
  {
    ...
    zh: {
      title: "面试与展示环节",
      why: "部分学校/项目把面试作为信号；是否准备充分会影响「可冲性」与风险描述。",
  ...
  },
  {
    ...
    zh: {
      title: "项目经历（夏校/科研/实习）",
      why: "项目经历常用来对齐「学术兴趣证据」与特定院系的偏好信号。",
  ...
  },
  {
    ...
    zh: {
      title: "选校范围与偏好",
      why: "明确范围能减少「重复类型学校」与地理/规模偏好冲突导致的无效扩张。",
      impact: "不补充时，更容易出现「看起来多但不互补」的名单结构风险。",
    },
    en: {
  ...
  },
  {
    ...
    zh: {
      title: "家庭/顾问协同",
      why: "决策链上的约束（预算拍板人、风险偏好）会改变「可执行策略」而不是纸面名单。",
      impact: "不补充时，行动表可能对「谁能拍板」假设过多，落地性下降。",
    },
    en: {
...
export function buildGapTask(rawLine: string, index: number, locale: Locale): GapTaskMeta {
  ...
  return {
    ...
    rawLine: raw,
    whyNeeded:
      "这条来自模型在报告里标注的「信息缺口」：它通常会影响档位划分、风险强弱或官网核对重点的排序。",
    impactIfMissing:
      "若不补充，报告仍可读，但对你的真实约束「贴脸度」会下降：冲/稳/保的边界与建议可能偏保守或偏乐观。",
  };
}
